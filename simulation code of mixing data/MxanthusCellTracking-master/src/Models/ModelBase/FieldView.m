    ...
    methods
        ...
        function update(obj)
            ...
            if ishandle(obj.hfig)
                ...
                %end
                obj.drawCellwt(obj.haxes,coords(1:obj.field.nCells,1),coords(1:obj.field.nCells,2),5,coords(1:obj.field.nCells,3));
                obj.drawCellpilc(obj.haxes,coords(obj.field.nCells+1:end,1),coords(obj.field.nCells+1:end,2),5,coords(obj.field.nCells+1:end,3));
        ...
        function drawCellpilc(~,haxes,x,y,l,o)
            line([x - l * cos(o) x + l * cos(o)]', ...
                 [y - l * sin(o) y + l * sin(o)]', ...
                 'Parent',haxes);
        end
        function drawCellwt(~,haxes,x,y,l,o)
            line([x - l * cos(o) x + l * cos(o)]', ...
                 [y - l * sin(o) y + l * sin(o)]', ...
                 'Color',[0.5 0.5 0.5],'Parent',haxes);
        end
    end
