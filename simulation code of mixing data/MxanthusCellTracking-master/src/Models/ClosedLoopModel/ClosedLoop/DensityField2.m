classdef DensityField2<Field2
    ...
    properties
		...
		nCellspil;%Number of pilc cells
    ...
    methods
        function obj = DensityField2(bandw,start_density,nCells,nCellspil)
			%
        ...
        function [] = reset(obj,modelStats,modelStatspil,probs,probspil)
	        %
            ...
            if(isempty(obj.start_density))
                ...
                for i = 1:obj.nCellspil
                    obj.cellList{i+obj.nCells} = AlignedCell(obj,modelStatspil,probspil,i);
                end
            else
                ...
                for i = 1:obj.nCellspil
                    obj.cellList{i+obj.nCells} = AlignedCell2(obj,modelStatspil,probspil,i);
                end
            end
...
%              s=sprintf('DenField%d',n);
%              currentStep=obj.currentStep;
%              alignfield=obj.alignment_field;
%             save(s,'currentStep','alignfield','obj.aMdl','obj.orientation','obj.density');
        end
        ...
        function obj = updateDensity(obj)
			...
			cellList = obj.cellList(1:obj.nCells);
