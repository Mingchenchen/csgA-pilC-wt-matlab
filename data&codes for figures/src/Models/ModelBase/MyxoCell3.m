classdef MyxoCell3<handle
  ...
  %
    ...
    methods
        ...
        %
        function obj = MyxoCell3(field,modelStats,probsin,probsout,ID,varargin)
            obj.field = field;
            obj.ID = ID;
            obj.ori = rand * 2 * pi;

            if(nargin < 6) %MyxoCell(field,modelStats,probs,ID)
