classdef Engine4<handle
    ...
    properties
        ...
        probspilin;          %Cell behavior model of pilc
        probspilout;  
%         probspilingoout;          %Cell behavior model of pilc
%         probspiloutgoout;
        inagg=logical([]);
        dencutoff=3;
    end
    ...
    methods
        ...
        %
        function obj = Engine4(field,probs,probspil, probspilout)
            obj.field = field;
            obj.probs = probs;
            obj.probspilin = probspil;
            obj.probspilout=probspilout;
%             obj.probspilingoout=probspil3;
%             obj.probspiloutgoout=probspil4;
