...
bandwidth = 15;
prerun_length = 180;
folder_name = '/Users/cotter/GitHub/CotterPNAS2017/Code/Models/ClosedLoopModel/Results/CorrectDensity/S5A/Results/S5A';
...
for run = 1:Nruns
    ...
    real_aggs = subStruct(agg_tracks,ismember(agg_tracks.id,union(stable_aggs)));
