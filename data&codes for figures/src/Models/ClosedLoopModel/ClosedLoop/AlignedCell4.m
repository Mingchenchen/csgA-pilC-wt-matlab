classdef AlignedCell4<MyxoCell4
    ...
    methods
        ...
        function obj = AlignedCell4(field,modelStats,probsin,probsout,ID,varargin)
	        %
	        %Constructor
	        %
            ...
            obj@MyxoCell4(field,modelStats,probsin,probsout,ID);  
        end
        ...
        function obj = reverse(obj,~,n)
            ...
            if agg_props.dist<=0 
            [time, spd, revAngle, beta1, ~, state] = obj.probsin.getTransitions(n,agg_props.phi,chi,agg_props.dist,density,obj.state);
               else 
                    [time, spd, revAngle, beta1, ~, state] = obj.probsout.getTransitions(n,agg_props.phi,chi,agg_props.dist,density,obj.state);
                end
