classdef DensityField3<Field2
    ...
    methods
        function obj = DensityField3(bandw,start_density,nCells,nCellspil)
			%
        ...
        function [] = reset(obj,modelStats,modelStatspil,probs,probspilin,probspilout)
	        %
            ...
            if(isempty(obj.start_density))
                ...
                for i = 1:obj.nCellspil
                    obj.cellList{i+obj.nCells} = AlignedCell3(obj,modelStatspil,probspilin,probspilout,i);
                end
            else
