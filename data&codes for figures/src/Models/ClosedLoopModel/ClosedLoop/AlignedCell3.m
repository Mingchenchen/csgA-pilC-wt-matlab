classdef AlignedCell3<MyxoCell3
    ...
    methods
        ...
        function obj = AlignedCell3(field,modelStats,probsin,probsout,ID,varargin)
	        %
	        %Constructor
	        %
            ...
            obj@MyxoCell3(field,modelStats,probsin,probsout,ID);  
        end
