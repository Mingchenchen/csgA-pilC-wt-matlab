classdef ClosedLoop4<Engine4
    ...
    methods        
        function obj = ClosedLoop4(probs,nCells,probspilin,probspilout,nCellspil,varargin)
	        %
            ...
            addRequired(p,'probspilin',@(x) isa(x,'ClosedLoopProbs3'));
            addRequired(p,'probspilout',@(x) isa(x,'ClosedLoopProbs3'));
            ...
            obj@Engine4( ...
                        DensityField4(p.Results.bandwidth, ...
