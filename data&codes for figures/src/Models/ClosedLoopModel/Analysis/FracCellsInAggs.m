...
Nruns = 3; 
folder_name = '/Volumes/Scratch/Chris/Paper2_Rippling/Paper2/data/raw/Simulations/ClosedLoop/PUB_NEW_1/Results/PUB_NEW_1/';  
prerun_length = 180;
simFracCurves = zeros(600 + prerun_length - 1,Nruns);
%AGG_DENSITY_CUTOFF = 5.5; % OLD PNAS VALUE
AGG_DENSITY_CUTOFF = 2.3; % Correct value
