...
tiff_file = CSGA_RAW_DEV_MOVIES('Exp1_35');

processed_folder = ['../data/processed/', CSGA_DEV_FOLDERS('Exp1_35')];
check_folder = ['../reports/DataChecks/', CSGA_DEV_FOLDERS('Exp1_35')];
...
if(~HEADLESS)
    figure
    detectCellsRegionProps(tiff_file,'MinLevel',29,'check',1,'large_cutoff',20);
end

%%
posList1 = detectCellsRegionProps(tiff_file,'MinLevel',29,'large_cutoff',20);
