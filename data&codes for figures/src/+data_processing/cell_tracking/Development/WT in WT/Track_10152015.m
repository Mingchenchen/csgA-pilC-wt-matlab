...
tiff_file = WT_RAW_DEV_MOVIES('10152015');

processed_folder = ['../data/processed/', WT_DEV_FOLDERS('10152015')];
check_folder = ['../reports/DataChecks/', WT_DEV_FOLDERS('10152015')];
...
if(~HEADLESS)
    figure
    detectCellsRegionProps(tiff_file,'MinLevel',2.5,'check',1,'large_cutoff',20);
end

%%
posList1 = detectCellsRegionProps(tiff_file,'MinLevel',2.5,'large_cutoff',20);
