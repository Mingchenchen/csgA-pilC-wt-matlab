...
tiff_file = CSGA_IN_CSGA_RAW_DEV_MOVIES('Exp1_31');

processed_folder = [PROJECT_BASENAME, '/data/processed/', CSGA_IN_CSGA_DEV_FOLDERS('Exp1_31')];
check_folder = [PROJECT_BASENAME '/reports/DataChecks/', CSGA_IN_CSGA_DEV_FOLDERS('Exp1_31')];
...
if(~HEADLESS)
    figure
    detectCellsRegionProps(tiff_file,'MinLevel',5.5,'check',1,'small_cutoff',3);
end

%%
posList1 = detectCellsRegionProps(tiff_file,'MinLevel',5.5,'small_cutoff',3);
