...
tiff_file = CSGA_RAW_RIPPLE_MOVIES('RIPPLE_25');

processed_folder = [PROJECT_BASENAME, '/data/processed/', CSGA_RIPPLE_FOLDERS('RIPPLE_25')];
check_folder = [PROJECT_BASENAME '/reports/DataChecks/', CSGA_RIPPLE_FOLDERS('RIPPLE_25')];
