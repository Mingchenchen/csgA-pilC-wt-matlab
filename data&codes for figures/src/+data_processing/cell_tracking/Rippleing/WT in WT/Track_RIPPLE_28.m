...
tiff_file = DIFA_RAW_RIPPLE_MOVIES('RIPPLE_28');

processed_folder = [PROJECT_BASENAME, '/data/processed/', DIFA_RIPPLE_FOLDERS('RIPPLE_28')];
check_folder = [PROJECT_BASENAME '/reports/DataChecks/', DIFA_RIPPLE_FOLDERS('RIPPLE_28')];
...
if(~HEADLESS)
    figure
    detectCellsRegionProps(tiff_file,'MinLevel',5.6,'check',1,'large_cutoff',20);
end

%%
posList1 = detectCellsRegionProps(tiff_file,'MinLevel',5.6,'small_cutoff',3);
