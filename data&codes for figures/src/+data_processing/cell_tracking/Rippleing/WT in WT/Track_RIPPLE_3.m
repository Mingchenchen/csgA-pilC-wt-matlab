...
tiff_file = WT_RAW_RIPPLE_MOVIES('RIPPLE_6');

processed_folder = [PROJECT_BASENAME, '/data/processed/', WT_RIPPLE_FOLDERS('RIPPLE_3')];
check_folder = [PROJECT_BASENAME '/reports/DataChecks/', WT_RIPPLE_FOLDERS('RIPPLE_3')];
